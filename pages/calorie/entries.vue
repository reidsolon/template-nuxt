...
import type {
  ...
  CalorieEntry,
} from '../../modules/calorie/_types/calorie';
  ...
  meta: [
    {
      name: 'description',
      content:
        'View, edit, and manage all your calorie entries. Track your food intake and monitor your nutrition goals.',
    },
  ],
});

const { initialize, entriesWithFood, addEntry, updateEntry, deleteEntry, duplicateEntry, isLoading } =
  useCalorieManager();
