  ...
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      ...
      <div class="flex items-center space-x-3">
        ...
        <div class="flex items-center space-x-2">
          <BaseButton variant="secondary" size="sm" @click="previousDay">
            <Icon name="heroicons:chevron-left" class="w-4 h-4" />
          </BaseButton>

          <BaseInput v-model="dateInput" type="date" @change="updateSelectedDate" class="w-auto" />

          <BaseButton variant="secondary" size="sm" @click="nextDay" :disabled="isToday">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <BaseCard class="p-6">
        ...
        <div class="space-y-2">
          <div class="flex justify-between items-baseline">
            ...
            <span class="text-sm text-gray-500"> of {{ activeGoal?.protein || 0 }}g </span>
          </div>
      ...
      <BaseCard class="p-6">
        ...
        <div class="space-y-2">
          <div class="flex justify-between items-baseline">
            <span class="text-2xl font-bold text-gray-900"> {{ Math.round(summary.totalNutrition.carbs || 0) }}g </span>
            <span class="text-sm text-gray-500"> of {{ activeGoal?.carbs || 0 }}g </span>
          </div>
      ...
      <BaseCard class="p-6">
        ...
        <div class="space-y-2">
          <div class="flex justify-between items-baseline">
            <span class="text-2xl font-bold text-gray-900"> {{ Math.round(summary.totalNutrition.fat || 0) }}g </span>
            <span class="text-sm text-gray-500"> of {{ activeGoal?.fat || 0 }}g </span>
          </div>
      ...
      <BaseCard class="p-4">
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-lg font-semibold text-gray-900">{{ Math.round(weeklyAverage) }} cal/day</p>
          </div>
        </div>
      </BaseCard>
      ...
      <BaseCard class="p-4">
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-lg font-semibold text-gray-900">{{ Math.round(monthlyAverage) }} cal/day</p>
          </div>
        </div>
      </BaseCard>
      ...
      <BaseCard class="p-4">
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-lg font-semibold text-gray-900">{{ progress.percentage }}%</p>
          </div>
        </div>
      </BaseCard>
    </div>
    ...
    >
      <div @click.stop class="w-full max-w-2xl">
        <CalorieEntryForm @add="handleAdd" @cancel="showAddForm = false" />
      </div>
    </div>
